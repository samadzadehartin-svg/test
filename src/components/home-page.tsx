...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#05080a] text-white">
      ...
      <section className="hero-scene relative min-h-[820px] pt-28">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_68%_20%,rgba(230,185,109,.11),transparent_28%),linear-gradient(180deg,rgba(2,5,7,.15),#05080a_93%)]" />
